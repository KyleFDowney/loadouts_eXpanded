...
function OnPlayerSpawned( player_entity ) -- this runs when player entity has been created
	...
	local player_sprite_file = "mods/loadouts_expanded/files/loadouts/" .. loadout_choice.folder .. "/player.xml"
	...
	local player_arm_sprite_file = "mods/loadouts_expanded/files/loadouts/" .. loadout_choice.folder .. "/player_arm.xml"
	...
	local player_ragdoll_file = "mods/loadouts_expanded/files/loadouts/" .. loadout_choice.folder .. "/ragdoll/filenames.txt"
	...
	GamePrintImportant( "You are " .. loadout_name .. "!", "" )
end
